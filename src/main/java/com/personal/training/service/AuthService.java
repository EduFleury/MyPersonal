...
public class AuthService {
    ...
    public LoginResponseDTO login(LoginRequestDTO dto) throws RegraNegocioException {
    ...
    public void trocarSenha(Long id, TrocaSenhaDTO dto) throws RegraNegocioException {
